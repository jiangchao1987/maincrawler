...
public class Database {
	...
	static {
		linkUri = String.format("jdbc:mysql://%s/%s?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull", Configure.getProperty("db_host"), Configure.getProperty("db_name"));
		try {
