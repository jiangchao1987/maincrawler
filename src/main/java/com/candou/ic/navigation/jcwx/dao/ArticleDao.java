...
public class ArticleDao {
    ...
    public static void addBatchArticles(List<Article> articles) {
        try {
            String sql = "INSERT IGNORE INTO jcwx_article (article_id,title,views,likes,wxh,wxqr,content,first_category_id,first_category_name,second_category_name,thumbnail,created_at,updated_at) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
