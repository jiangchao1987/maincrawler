...
public class PPFreeMain {
	...
	private static String[] free = {
			"http://pppc.25pp.com/apple/soft?son_phone_typeid=2&a=softFree&orderby=publishDate&catid=0&page=%d",
			"http://pppc.25pp.com/apple/soft?son_phone_typeid=2&a=gameFree&orderby=publishDate&catid=0&page=%d" };
